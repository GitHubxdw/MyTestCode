...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xudongwei/MyTestCode'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xudongwei' => 'xudongwei@codemao.cn' }
  s.source           = { :git => 'https://github.com/xudongwei/MyTestCode.git', :tag => s.version.to_s }
